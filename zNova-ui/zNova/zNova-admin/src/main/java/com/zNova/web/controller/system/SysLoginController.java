...
import com.zNova.common.core.domain.entity.SysMenu;
import com.zNova.common.core.domain.entity.SysUser;
import com.zNova.common.core.domain.model.LoginBody;
...
import com.zNova.framework.web.service.SysLoginService;
import com.zNova.framework.web.service.SysPermissionService;
import com.zNova.framework.web.service.TokenService;
import com.zNova.system.service.ISysConfigService;
import com.zNova.system.service.ISysMenuService;
...
public class SysLoginController
{
    ...
    public AjaxResult getInfo()
    {
        ...
        // 调试日志：检查用户信息是否包含deptId
        System.out.println("getInfo - 用户ID: " + user.getUserId() + ", 用户名: " + user.getUserName() + ", deptId: " + user.getDeptId());
