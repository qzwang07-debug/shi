...
import com.zNova.common.core.domain.entity.SysDept;
...
import com.zNova.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    {
        // 调试日志：检查接收到的用户信息
        System.out.println("SysUserController.add - 接收到新增用户请求:");
        System.out.println("  - userName: " + user.getUserName());
        System.out.println("  - nickName: " + user.getNickName());
        System.out.println("  - deptId: " + user.getDeptId());
        System.out.println("  - deptId类型: " + (user.getDeptId() != null ? user.getDeptId().getClass().getName() : "null"));
        ...
        // 调试日志：检查设置后的用户信息
        System.out.println("SysUserController.add - 准备插入数据库的用户信息:");
        System.out.println("  - userName: " + user.getUserName());
        System.out.println("  - deptId: " + user.getDeptId());
