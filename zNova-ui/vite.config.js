          ...
          configure: (proxy, options) => {
            proxy.on('proxyReq', (proxyReq, req, res) => {
              ...
              if (originalHeaders.authorization) {
                proxyReq.setHeader('Authorization', originalHeaders.authorization);
                console.log("✅ 设置Authorization头:", originalHeaders.authorization);
              } else {
            ...
            proxy.on('proxyRes', (proxyRes, req, res) => {
              console.log("代理响应:", proxyRes.statusCode, "for", req.url);
            });
          }
        }
      }
